...
#load images
bg_img = pygame.image.load('data/6bg.jpg')
bg_img = pygame.transform.scale(bg_img, (screen_width, screen_height - margin))
dirt_img = pygame.image.load('data/stoneCenter.png')
grass_img = pygame.image.load('data/stoneMid.png')
blob_img = pygame.image.load('data/snailWalk1.png')
platform_x_img = pygame.image.load('data/stoneHalf.png')
platform_y_img = pygame.image.load('data/stoneHalf.png')
lava_img = pygame.image.load('data/spikes.png')
...
for tile in range(0, 15):
	world_data[14][tile] = 2
	world_data[0][tile] = 1
	world_data[tile][0] = 1
	world_data[tile][14] = 1
		...
		for col in range(15):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 8:
					#exit
					img = pygame.transform.scale(exit_img, (tile_size, int(tile_size * 2)))
					screen.blit(img, (col * tile_size, row * tile_size - (tile_size // 2)))
